...
const Profile = () => {
  ...
  const [userDetails, setUserDetails] = useState({
    ...
    school: "ABC School",
    description:
      "Hi, I'm John! I'm a passionate web developer with a love for creating amazing user experiences.",
    ...
    <Layout>
      <div className="flex items-center justify-center rounded-4xl h-screen bg-gray-100 cursor-pointer">
        <div className="bg-white p-8 rounded-3xl shadow-md text-gray-800 w-96">
          ...
          <div>
            <button
              className={`px-1 py-1 rounded focus:outline-none text-sm ${
                editMode ? "hidden" : "text-blue-500 hover:underline"
              }`}
            ...
            <div className={`${editMode ? "" : "hidden"}`}>
              <label className="block text-sm font-medium text-blue-500 mt-4 text-center">
                Name:
              </label>
              <input
                type="text"
            ...
            >
              ...
              <p>
                <span className="font-medium">Class:</span> {userDetails.class}
              </p>
              <p>
