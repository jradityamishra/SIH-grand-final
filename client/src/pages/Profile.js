...
const Profile = () => {
  ...
  return (
   <Layout>
     <div className="flex items-center justify-center rounded-4xl h-screen bg-gray-100">
      <div className="bg-white p-8 rounded-3xl shadow-md text-gray-800 w-96">
        ...
        <div>
          ...
          <div className={`${editMode ? '' : 'hidden'}`}>
            <label className="block text-sm font-medium text-blue-500 mt-4">Name:</label>
            <input
              type="text"
              name="name"
