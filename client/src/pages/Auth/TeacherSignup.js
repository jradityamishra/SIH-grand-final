...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      alert("Registration Successful"); // Use alert instead of toast
    } catch (err) {
      console.log(err);
        ...
        <div className="w-11/12 max-w-[600px]  px-10 py-10 absolute top-10 left-10 rounded-3xl bg-white border-2 border-gray-100">
          ...
          <div className="mb-4">
            ...
            <div className="mb-2">
              ...
              <select
                className="w-full border-2 border-gray-50 rounded-md p-2 bg-transparent focus:border-indigo-600"
                value={subject}
            ...
            <div className="mb-2">
              ...
              <input
                className="w-full border-2 border-gray-100 rounded-md p-2 bg-transparent"
                placeholder="somethong about yourself"
                value={about}
            ...
            <div className="mb-2">
              ...
              <input
                className="w-full border-2 border-gray-100 rounded-md p-2 bg-transparent focus:border-indigo-600"
                value={teacherClass}
          ...
          <div className="flex flex-col gap-y-4">
            <button
              className="w-full py-3 bg-indigo-500 text-white rounded-md font-semibold text-md hover:bg-indigo-600"
