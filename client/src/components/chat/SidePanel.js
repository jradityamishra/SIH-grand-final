...
const SidePanel = () => {
  ...
  const handleConfirmCreateGroup = async () => {
    if (!newGroupName || !selectedUsers) {
      alert("plese fill all the toast");
      return;
    }
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `/api/v1/chat/getGroup/${userStudent._id}`
      );
          ...
          <div className="bg-white p-4 w-96">
            ...
            {selectedUsers.map((u) => (
              <span
                ...
                class="inline-flex items-center my-1 mx-1 px-2 py-1 me-2 text-sm font-medium text-gray-800 bg-gray-100 rounded dark:bg-gray-700 dark:text-gray-300"
              >
                {u.name}
                <button
                  type="button"
            ...
            {loading ? (
              ...
              searchResult?.map((user) => (
                <div
                  class="bg-indigo-900 text-center py-4 lg:px-4 cursor-pointer"
                ...
                >
                  ...
                  >
                    ...
                    <div class="flex flex-col ml-2">
                      <span class="font-semibold mr-2 text-left flex-auto mt-1 mb-1">
                        {user.name}
                      </span>
