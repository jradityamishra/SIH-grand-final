...
export const getQuiz = async (req, res, next) => {
  ...
  const content = `${summary}\nGenerate multiple-choice questions and answers based on the above summary(ignore HTML tags).Create 6 questions, each with 4 options in an array numbered using capital letters . Return a JSON object without comments and special characters, containing an array of multiple-choice questions with their options (MCQs) and an array of answers(answers) stating the correct option using capital letters.`;
  const options = {
    method: "POST",
    url: "https://chatgpt-42.p.rapidapi.com/matag2",
    headers: {
